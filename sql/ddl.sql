...
(
    ...
    accessKey    varchar(512) default 'start'           not null comment 'accessKey',
    secretKey    varchar(512) default 'a123456'         not null comment 'secretKey',
...
(
    id             bigint auto_increment comment 'id' primary key,
    name           varchar(256)              not null comment '接口昵称',
...
(
    ...
    totalNumber    int    default 0                 not null comment '总调用次数',
    leftNumber     int    default 0                 not null comment '剩余调用次数',
